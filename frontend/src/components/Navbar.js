  ...
  <Container>
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      <Nav className='me-auto'>
        ...
        <Nav.Link as={Link} to="/rewards" style={{ color: "white", fontWeight: "bold" }}><Button variant="outline-light">Rewards</Button></Nav.Link>
        <Nav.Link as={Link} to="/faucet" style={{ color: "white", fontWeight: "bold" }}><Button variant="outline-light">Faucet</Button></Nav.Link>
      </Nav>
      <Nav>
        {account ? (
          <Nav.Link
